...
# plot
pal = serie_palette("bolt", palette_anime, 12)
pal = colorRampPalette(pal)(ngroup)
pal=pal[sample(c(1:length(pal)) , size=length(pal) ) ]
...
# plot
pal = serie_palette("poputepik", palette_anime, 12)
pal = colorRampPalette(pal)(ngroup)
pal=pal[sample(c(1:length(pal)) , size=length(pal) ) ]
...
# plot
pal = serie_palette("tokyorev", palette_anime, 12)
pal = colorRampPalette(pal)(ngroup)
pal=pal[sample(c(1:length(pal)) , size=length(pal) ) ]
...
# plot
pal = serie_palette("yona", palette_anime, 12)
pal = colorRampPalette(pal)(ngroup)
pal=pal[sample(c(1:length(pal)) , size=length(pal) ) ]
...
# plot
pal = serie_palette("cardcaptor", palette_anime, 12)
pal = colorRampPalette(pal)(ngroup)
pal=pal[sample(c(1:length(pal)) , size=length(pal) ) ]
