...
We can select until 3 palette families at the moment: `palette_netflyx`, `palette_anime`,`palette_peru`. Each family is a list of palette from series. Each palette in this package have a total of 6 colors. With the function `serie_palette` we can select a palette following this entry:
